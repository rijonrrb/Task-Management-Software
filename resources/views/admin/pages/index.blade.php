...
$(function () {
    $('#pagesTable').DataTable({
        ...
        columns: [
            { data: 'title',       name: 'title',        orderable: true,  searchable: true,  defaultContent: '' },
            { data: 'slug',        name: 'slug',         orderable: false, searchable: true,  responsivePriority: 4, defaultContent: '',
              render: function (data) { return '<span class="text-xs text-gray-400 font-mono">/page/' + (data || '') + '</span>'; }
            },
            { data: 'status_html', name: 'is_published', orderable: true,  searchable: false, responsivePriority: 2, defaultContent: '' },
            { data: 'menu_html',   name: 'show_in_menu', orderable: false, searchable: false, responsivePriority: 5, defaultContent: '' },
            { data: 'created_at',  name: 'created_at',   orderable: true,  searchable: false, responsivePriority: 3, defaultContent: '' },
